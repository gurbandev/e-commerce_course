                                    ...
                                    <div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="mb-0">Hello {{ $userData->username }}!</h3>
                                                <br>
                                                <img id="showImage" src="{{ !empty($userData->photo) ? asset('upload/user_images/'.$userData->photo) : asset('upload/no_image.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary img-fit" style="width: 110px; height: 100px;">
                                            </div>
                                            <div class="card-body">
                                                <p>
                                                ...
                                                <form action="{{ route('user.update.password') }}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input required="" class="form-control @error('old_password') is-invalid @enderror" placeholder="Old Password" name="old_password" id="old_password" type="password" />
                                                            @error('old_password')
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input required="" class="form-control @error('new_password') is-invalid @enderror" placeholder="New Password" name="new_password" id="new_password" type="password" />
                                                            @error('new_password')
                                                            <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label>Password <span class="required">*</span></label>
                                                            <input required="" class="form-control" placeholder="Confirm New Password" name="new_password_confirmation" id="new_password_confirmation" type="password" />
